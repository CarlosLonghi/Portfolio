export function Github() {
  return (
    <a
      className="flex items-center gap-1 font-semibold transition duration-300 ease-out hover:text-cyan-300"
...
export function Linkedin() {
  return (
    <a
      className="flex items-center gap-1 font-semibold shadow-lg transition duration-300 ease-out hover:text-cyan-300"
