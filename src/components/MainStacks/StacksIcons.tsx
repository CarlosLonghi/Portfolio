...
const StackIcon = ({ children, link }: StackIconProps) => {
  return (
    <a
...
export function IconLaravel(props: React.SVGProps<SVGSVGElement>) {
  return (
    <StackIcon link="https://laravel.com">
      <svg
        viewBox="0 0 512 512"
        fill="currentColor"
        height="1em"
        width="1em"
        className="h-12 w-12 text-orange-600 transition group-hover:text-orange-500"
        {...props}
      >
      ...
      <span className="text-center text-sm font-semibold text-orange-600 transition group-hover:text-orange-500">
        Laravel
      </span>
    </StackIcon>
  )
...
export function IconNodeJs(props: React.SVGProps<SVGSVGElement>) {
  return (
    <StackIcon link="https://nodejs.org/en">
      <svg
        viewBox="0 0 448 512"
        fill="currentColor"
        height="1em"
        width="1em"
        className="h-12 w-12 text-green-500 transition group-hover:text-green-400"
        {...props}
      >
      ...
      <span className="text-center text-sm font-semibold text-green-500 transition group-hover:text-green-400">
        Node
      </span>
    </StackIcon>
  )
...
export function IconReact(props: React.SVGProps<SVGSVGElement>) {
  return (
    <StackIcon link="https://react.dev">
      <svg
        viewBox="0 0 512 512"
        fill="currentColor"
        height="1em"
        width="1em"
        className="h-12 w-12 text-cyan-400 transition group-hover:text-cyan-300"
        {...props}
      >
      ...
      <span className="text-center text-sm font-semibold text-cyan-400 transition group-hover:text-cyan-300">
        React
      </span>
    </StackIcon>
  )
