...
export default function Carrer() {
  return (
    <motion.section
      className="m-auto min-h-[calc(100vh-5.9rem)] max-w-app space-y-8 px-6 pb-8 pt-20 sm:px-10 md:min-h-[calc(100vh-10.6rem)] md:px-12 md:pt-14"
      initial="hidden"
      animate="visible"
    >
      <motion.div className="md:w-1/2" variants={animationBottomToTop}>
        <div className="flex items-center gap-4">
          <h2 className="mb-2 text-2xl font-semibold md:text-3xl">Carreira</h2>
